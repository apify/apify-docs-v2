...
Now, let's write some data collection code to collect each product's data. This should look familiar if you went through the [Data Collection](../../webscraping/web_scraping_for_beginners/data_collection/index.md) lessons:
