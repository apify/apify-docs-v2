...
If we create a new actor using the code below on the [Apify platform](../apify_platform.md), it returns a nicely formatted spreadsheet containing a list of breweries with their beers with descriptions.
