...
The one main difference is that the Apify client automatically uses [**exponential backoff**](/client-js/api#retries-with-exponential-backoff) to deal with errors.
