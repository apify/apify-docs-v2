...
The one main difference is that the Apify client automatically uses [**exponential backoff**](https://docs-v2.apify.com/client-js#retries-with-exponential-backoff) to deal with errors.
