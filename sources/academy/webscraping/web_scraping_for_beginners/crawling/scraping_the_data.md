...
At the [very beginning of the course](../index.md), we learned that the term web scraping usually means a combined process of data collection and crawling. And this is exactly what we'll do in this lesson. We will take the code we built in the previous lesson and in the [Basics of data collection](../data_collection/node_continued.md) section, and we will combine that into a web scraper.
