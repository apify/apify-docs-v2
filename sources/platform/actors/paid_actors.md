...
Yes, when you are renting a paid actor, you can run it using either our [API](/api/v2) or [JavaScript](https://docs.apify.com/client-js) or [Python](https://docs.apify.com/client-python) clients as you would do with private or free public actors.
