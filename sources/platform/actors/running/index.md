...
- Python: using the [`call()`](https://docs.apify.com/client-python#actorclient-call) function provided by the [`apify-client`](https://docs.apify.com/client-python) Python package.
