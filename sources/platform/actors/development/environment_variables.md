...
| `APIFY_ACTOR_EVENTS_WS_URL`        | Websocket URL where actor may listen for events from Actor platform. See [documentation](https://docs-v2.apify.com/sdk-js/api/apify/class/PlatformEventManager) for more information.                                       |
...
| `APIFY_PROXY_PASSWORD`             | The [Apify Proxy](../../proxy) password of the user who started the actor.                                                                                                                                            |
